...
/**
 * Created by Gibah on 10/11/2017.
 */

public class psd_mainspecs_tab extends Fragment{

    private TextView name, named, model, modeled, opsys, opsysed, processor, processored, network, networked,
    ...
    private Button apple, bb, htc, huawei, infinix, lenovo, lg, samsung, tecno, compare;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.psd_mainspecs_tab, container, false);
        return rootView;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mInterstitialAd.setAdUnitId(getString(R.string.my_usb_otg_interstitial_psd));
        mInterstitialAd.loadAd(new AdRequest.Builder().build());

        name = (TextView) getView().findViewById(R.id.name);
        named = (TextView) getView().findViewById(R.id.named);
        model = (TextView) getView().findViewById(R.id.model);
        modeled = (TextView) getView().findViewById(R.id.modeled);
        opsys = (TextView) getView().findViewById(R.id.opsys);
        opsysed = (TextView) getView().findViewById(R.id.opsysed);
        processor = (TextView) getView().findViewById(R.id.processor);
        processored = (TextView) getView().findViewById(R.id.processored);
        network = (TextView) getView().findViewById(R.id.network);
        networked = (TextView) getView().findViewById(R.id.networked);
        appearance = (TextView) getView().findViewById(R.id.appearance);
        appearanced = (TextView) getView().findViewById(R.id.appearanced);
        display = (TextView) getView().findViewById(R.id.display);
        displayed = (TextView) getView().findViewById(R.id.displayed);
        camera = (TextView) getView().findViewById(R.id.camera);
        cameraed = (TextView) getView().findViewById(R.id.cameraed);
        memory = (TextView) getView().findViewById(R.id.memory);
        memoryed = (TextView) getView().findViewById(R.id.memoryed);
        con_sensor = (TextView) getView().findViewById(R.id.con_sensor);
        con_sensored = (TextView) getView().findViewById(R.id.con_sensored);
        battery = (TextView) getView().findViewById(R.id.battery);
        batteryed = (TextView) getView().findViewById(R.id.batteryed);
        other = (TextView) getView().findViewById(R.id.other);
        othered = (TextView) getView().findViewById(R.id.othered);
        apple = (Button) getView().findViewById(R.id.apple);
        bb = (Button) getView().findViewById(R.id.bb);
        htc = (Button) getView().findViewById(R.id.htc);
        huawei = (Button) getView().findViewById(R.id.huawei);
        infinix = (Button) getView().findViewById(R.id.infinix);
        lenovo = (Button) getView().findViewById(R.id.lenovo);
        lg = (Button) getView().findViewById(R.id.lg);
        samsung = (Button) getView().findViewById(R.id.samsung);
        tecno = (Button) getView().findViewById(R.id.tecno);
    ...
    private void getapplebrand(String applebrand) {
        ...
        switch (applebrand) {
            ...
            case "iPhone 8":
                ...
                named.setText(getString(R.string.iP8_named));
                modeled.setText(getString(R.string.iP8_modeled));
                opsysed.setText(getString(R.string.iP8_opsysed));
                processored.setText(getString(R.string.iP8_processored));
                networked.setText(getString(R.string.iP8_networked));
                appearanced.setText(getString(R.string.iP8_appearanced));
                displayed.setText(getString(R.string.iP8_displayed));
                cameraed.setText(getString(R.string.iP8_cameraed));
                memoryed.setText(getString(R.string.iP8_memoryed));
                con_sensored.setText(getString(R.string.iP8_con_sensored));
                batteryed.setText(getString(R.string.iP8_batteryed));
                othered.setText(getString(R.string.iP8_othered));
                break;
            ...
            case "iPhone 8 Plus":
                ...
                named.setText(getString(R.string.iP8p_named));
                modeled.setText(getString(R.string.iP8p_modeled));
                opsysed.setText(getString(R.string.iP8p_opsysed));
                processored.setText(getString(R.string.iP8p_processored));
                networked.setText(getString(R.string.iP8p_networked));
                appearanced.setText(getString(R.string.iP8p_appearanced));
                displayed.setText(getString(R.string.iP8p_displayed));
                cameraed.setText(getString(R.string.iP8p_cameraed));
                memoryed.setText(getString(R.string.iP8p_memoryed));
                con_sensored.setText(getString(R.string.iP8p_con_sensored));
                batteryed.setText(getString(R.string.iP8p_batteryed));
                othered.setText(getString(R.string.iP8p_othered));
                break;
            ...
            case "iPhone X":
                ...
                named.setText(getString(R.string.iPx_named));
                modeled.setText(getString(R.string.iPx_modeled));
                opsysed.setText(getString(R.string.iPx_opsysed));
                processored.setText(getString(R.string.iPx_processored));
                networked.setText(getString(R.string.iPx_networked));
                appearanced.setText(getString(R.string.iPx_appearanced));
                displayed.setText(getString(R.string.iPx_displayed));
                cameraed.setText(getString(R.string.iPx_cameraed));
                memoryed.setText(getString(R.string.iPx_memoryed));
                con_sensored.setText(getString(R.string.iPx_con_sensored));
                batteryed.setText(getString(R.string.iPx_batteryed));
                othered.setText(getString(R.string.iPx_othered));
                break;

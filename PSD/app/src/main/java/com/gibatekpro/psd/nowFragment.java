...
public class nowFragment extends Fragment {
    ...
    TextView name, named, model, modeled, opsys, opsysed, processor, processored, network, networked,
            ...
            cameraed, memory, memoryed, con_sensor, con_sensored, battery, batteryed, other, othered, selecttocompare;
    Button apple, bb, htc, huawei, infinix, lenovo, lg, samsung, tecno, compare;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mInterstitialAd.setAdUnitId(getString(R.string.PSD_COMPARE_INTERSTITIAL));
        ...
        selecttocompare = (TextView) getView().findViewById(R.id.selecttocompare);
        compare = (Button) getView().findViewById(R.id.compare);
        ...
        selecttocompare.setText(R.string.selecttocompare);
    ...
    /*public void loadTutorial() {
        ...
        mainAct.putParcelableArrayListExtra(MaterialTutorialActivity.MATERIAL_TUTORIAL_ARG_TUTORIAL_ITEMS, getTutorialItems(getActivity()));

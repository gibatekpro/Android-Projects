...
import com.gibatekpro.imeiinfo.Auth.User;
...
public class User_Account extends AppCompatActivity {
    ...
    private boolean checkNew() {
        ...
        Boolean showTutorioals = sharedPreferences.getBoolean("REGBOARDINGIMEIINFO", true);
        ...
        if (showTutorioals) {
            ...
            editor.putBoolean("REGBOARDINGIMEIINFO", false);
            editor.apply();

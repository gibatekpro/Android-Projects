...
public class turkAppRater {
    ...
    private static void showRateDialog(final Context context, final SharedPreferences.Editor editor) {
        ...
        String message = "Hoşlanıyorsan "
                + APP_TITLE
                + ", Uygulamayı değerlendirmek için biraz zaman ayırın. "
                + "Desteğin için teşekkürler!";

        builder.setMessage(message)
                .setTitle("değerlendir " + APP_TITLE)
                ...
                .setPositiveButton("Evet", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        try {
                            ...
                            Toast.makeText(context, "Evet düğmesine basmışsın", Toast.LENGTH_SHORT).show();
                        }
                        dialog.dismiss();
                    }
                })
                .setNeutralButton("Şimdi değil", new DialogInterface.OnClickListener(){

                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(context, "Şimdi değil düğmesine basmışsın", Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
                    }
                })
                .setNegativeButton("Yok hayır!", new DialogInterface.OnClickListener(){
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(context, "Hayır düğmesine basmışsın", Toast.LENGTH_SHORT).show();

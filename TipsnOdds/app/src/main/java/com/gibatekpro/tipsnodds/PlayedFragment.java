...
import com.gibatekpro.tipsnodds.Adapters.MyAdapter_played;
import com.gibatekpro.tipsnodds.ListItems.ListItem_played;
...
public class PlayedFragment extends Fragment {
    ...
    private List<ListItem_played> listItems;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.played, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        ((MainActivity)getActivity()).load_played();
        //[END Load Data From Main Activity]

    }
    //[END OnView Created Method]
    ...
    public void loadData(Task<QuerySnapshot> task) {
        ...
        for (DocumentSnapshot doc : task.getResult()) {
            ...
            ListItem_played played = new ListItem_played(CheckIcon,
                    flag,
                    doc.getString("id"),
            ...
            listItems.add(played);

        }
        //[END Feeding Data From Main Activity Into List]

        //[START RecyclerView Function]
        RecyclerView.Adapter adapter = new MyAdapter_played(listItems, getActivity());

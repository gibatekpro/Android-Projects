...
public class MyAdapter_played extends RecyclerView.Adapter<MyAdapter_played.ViewHolder> {

    private List<ListItem_played> listItems;
    private Context context;

    public MyAdapter_played(List<ListItem_played> listItems, Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        ListItem_played listItem = listItems.get(position);

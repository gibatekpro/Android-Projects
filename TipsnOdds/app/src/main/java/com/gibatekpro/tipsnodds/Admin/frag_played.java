...
public class frag_played extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.frag_played, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        listItem_played = getView().findViewById(R.id.listTodo_played);
        listItem_played.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(getActivity());
        listItem_played.setLayoutManager(layoutManager);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        if (item.getTitle().equals("DELETE PLAYED"))
    ...
    private void updateData(String progress_edit, String date_edit, String time_edit, String country_edit, String home_club_edit, String away_club_edit, String tip_edit, String odds_edit) {
        ...
        db.collection("Played").document(idUpdate)
    ...
    public void loadData(Task<QuerySnapshot> task) {
        ...
        for (DocumentSnapshot doc : task.getResult()) {
            ...
            ToDo_played toDo = new ToDo_played(CheckIcon,
                    flag,
        ...
        adapter = new ListItemAdapter_played(frag_played.this, toDoList);
        listItem_played.setAdapter(adapter);
